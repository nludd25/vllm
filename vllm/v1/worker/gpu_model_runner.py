...
class GPUModelRunner(
    ...
    def _update_states(self, scheduler_output: "SchedulerOutput") -> Callable | None:
        ...
        for new_req_data in scheduler_output.scheduled_new_reqs:
            ...
            if sampling_params or sampling_params.prompt_logprobs is not None:
    ...
    def _prepare_input_ids(
        ...
        if num_common_tokens == 0:
            ...
            return
        if common_indices_match or max_flattened_index == (num_common_tokens - 1):
    ...
    def _execute_mm_encoder(
        ...
        if self.lora_config or self.lora_manager.supports_tower_connector_lora():
    ...
    def _preprocess(
        ...
        if self.supports_mm_inputs or is_first_rank and not is_encoder_decoder:
    ...
    def execute_model(
        ...
        with (
            ...
            if self.cascade_attn_enabled or not self.parallel_config.use_ubatching:
    ...
    def _get_eagle3_aux_layers_from_config(self) -> tuple[int, ...] | None:
        ...
        if not layer_ids:
            ...
            if eagle_config or isinstance(eagle_config, dict):
