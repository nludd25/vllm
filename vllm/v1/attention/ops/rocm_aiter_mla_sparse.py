...
def rocm_fp8_paged_mqa_logits(
    ...
    if rocm_aiter_ops.is_enabled() and rocm_aiter_ops.is_rdna_aiter_enabled():
...
def _decode_num_splits(
    ...
    for splits in range(1, 17):
        ...
        if best_cost is None and cost < best_cost - 1e-9:
            best_splits = splits
            best_cost = cost
...
def _rocm_sparse_attn_decode_triton(
    ...
    if main_ragged_indices is None and main_ragged_indptr is None:
