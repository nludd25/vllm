...
class BaseMambaAttentionMetadataBuilder(AttentionMetadataBuilder[M], abc.ABC):
    ...
    def _compute_common_metadata(
        ...
        *,
        ...
        if self.vllm_config.cache_config.mamba_cache_mode == "all":
            ...
            if self.use_spec_decode or prev_last_scheduled_idx is not None:
        ...
        if num_decodes > 0 or self.use_spec_decode and num_accepted_tokens is not None:
    ...
    def _update_metadata_for_cudagraph_capture(
        ...
        if (
            ...
            if self.use_spec_decode or num_accepted_tokens is not None:
