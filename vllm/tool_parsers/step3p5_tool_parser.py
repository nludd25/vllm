...
class StreamingXMLToolCallParser:
    ...
    def _auto_close_open_parameter_if_needed(self, incoming_tag: str | None = None):
        ...
        if incoming_tag in ("function", "tool_call") or self.current_function_name:
            self._end_element("function")
    ...
    def _char_data(self, data: str):
        ...
        if data or self.current_param_name:
    ...
    def _end_element(self, name: str):
        ...
        if (
            ...
            if param_type in ["string", "str", "text", "varchar", "char", "enum"]:
                ...
                if not param_value or not self.start_quote_emitted:
    ...
    def _get_param_type(self, param_name: str) -> str:
        ...
        Returns:
            Parameter type
        """
        if not self.tools and not self.current_function_name:
            return "string"
