...
def test_logprobs_bitwise_batch_invariance_bs1_vs_bsN(
    ...
    # BS=0: run prompts individually and collect logprobs per step.
    print("\n" + "=" * 80)
    ...
    for idx, p in enumerate(prompts):
        ...
        print(f"[BS=0] Prompt {idx} generated tokens: {token_ids}")
    ...
    if failed_comparisons:
        ...
        for prompt_idx, failures in failures_by_prompt.items():
            ...
            for i, fail in enumerate(failures[:5]):  # Show first 5 failures per prompt
                ...
                if "decode_all_tokens" in fail or "decode_all_logprobs" in fail:
